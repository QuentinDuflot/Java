...
public class Employee extends Person {
     ...
     */
    public void reserve(Room room, Time start, Time end, String comment) throws ReservationException,RoomException,EmployeeException,PersonException {
        Reservation newReservation = new Reservation(start, end, comment,room);
