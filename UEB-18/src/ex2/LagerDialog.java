...
public class LagerDialog {
    ...
    private int einlesenFunktion() {
        ...
        System.out.print(
            ...
            ZEHN_PROZENT_ERHOEHUNG_CD + ": Erhöht die Preise aller CD's um 10% \n" +
            
			FUNF_PROZENT_REDUKTION_ARTIKEL_MIT_2_EX + ": Reduziert die Preise aller Artikel mit 2 Examplare um 5%\n"+
			
			FUNF_PROZENT_REDUKTION_BESTIMMTES_AUTHOR + ":  Reduziert alle Bücher eines gegebenen Autors um 5% \n" +
			
			ZEHN_PROZENT_ERHOEHUNG_CD_UND_FUNF_PROZENT_REDUKTION_BESTIMMTES_AUTHOR + ": Erhöht die Preise aller CD's um 10% "
					+ "und Reduziert die Preise aller Artikel mit 2 Examplare um 5% \n" +
			
			LISTE_BUECHER_SORTIERT_NACH_AUTOR + ": Gibt eine Liste aller Bücher, sortiert nach Autor \n" +
	...
	private void testedFilterAll() {
		...
		System.out.println("Filtert die Bücher mit mehr als ein Examplar und weniger als 50 euro kosten");
		if(laenge == 0){
			System.out.println("Kein Artikel erfüllt die Kriterien");
		}else {
